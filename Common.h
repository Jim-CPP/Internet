...
#define SHELL_EXECUTE_MAXIMUM_FAILURE_RETURN_VALUE								32
// Note that you need to cast ShellExecute to an INT_PTR in order to use the above, e.g.
//
//		// Open item
//		if( ( INT_PTR )ShellExecute( NULL, SHELL_EXECUTE_OPEN_COMMAND, lpszFilePath, NULL, NULL, SW_SHOWDEFAULT ) > SHELL_EXECUTE_MAXIMUM_FAILURE_RETURN_VALUE )
//		{
